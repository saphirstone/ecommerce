...
class KittensControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create kitten" do
    assert_difference('Kitten.count') do
      post kittens_url, params: { kitten: { color: @kitten.color, condition: @kitten.condition, description: @kitten.description, finish: @kitten.finish, price: @kitten.price, race: @kitten.race, title: @kitten.title } }
    end
  ...
  test "should update kitten" do
    patch kitten_url(@kitten), params: { kitten: { color: @kitten.color, condition: @kitten.condition, description: @kitten.description, finish: @kitten.finish, price: @kitten.price, race: @kitten.race, title: @kitten.title } }
